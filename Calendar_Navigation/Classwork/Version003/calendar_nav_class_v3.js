...
function intialElems() {
    // date heading elm
    let dateDisplay = createHeading({ id: `dateHead`, text: ``, size: 1 });
...
function startSelect() {
    ...
    if (document.getElementById(`dateHead`).style.display != `none`) {
        ...
        document.getElementById(`dateHead`).innerHTML = `${dateInfo.storedDate[0]}<br>`;
...
function selectDay() {
    ...
    dateInfo.storedDate.unshift(`${dateInfo.month + 1}/${dateInfo.day}/${dateInfo.year}`);
    document.getElementById(`dateHead`).innerHTML = `${dateInfo.month + 1}/${dateInfo.day}/${dateInfo.year}<br>`;
    document.getElementById(`dateHead`).style.display = `initial`;
